...
var GameUI = (function (_super) {
    ...
    function GameUI() {
        ...
        _this.score = 0;
        _this.countdownMaxNumber = 30;
        _this.gameStatus = 1;
        _this.curIndex = 0; //当前的物品索引
        _this.star = false;
        _this.jj = "+";
        _this.bl = true;
    ...
    GameUI.prototype.createView = function () {
        ...
        var rect = new egret.Rectangle(0, 0, this.$stage.width, this.$stage.height);
        oldMask.mask = rect;
        //雪人动画
    ...
    GameUI.prototype.loop = function () {
        //倒计时
        if (this.gameStatus == 1) {
            ...
            for (var k in this.gifArr) {
                if (this.gifArr[k].bitmap.touchEnabled == true) {
                    if (this.gifArr[k].bitmap.y - this.gifArr[k].bitmap.height * .5 >= this.snowman1.y &&
    ...
    GameUI.prototype.go_on = function () {
