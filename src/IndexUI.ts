class IndexUI extends egret.Sprite {
    ...
    private ERROR_MESSAGE = mc_content.ERROR_MESSAGE;
    ...
    private showPrizePlatform(){
        ...
        var typeText:egret.TextField = createTextFiledNoEui("");
        var prizeValueText:egret.TextField = createTextFiledNoEui("");
        ...
        // rdm_btn.y = congText.y + congText.height + 0;
